...
public class NaiveLongestPalindromeTest {
    NaiveLongestPalindrome sol;

    @Before
    public void setUp(){
        sol = new NaiveLongestPalindrome();
    }
    ...
    public void testMultipleSameChar(){
        ...
        Assert.assertEquals("adada", sol.longestPalindrome("xxaxxabababa"));
